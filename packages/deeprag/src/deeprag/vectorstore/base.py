...
class VectorStore(ABC):
    ...
    the rest of our RAG pipeline doesn't need to change its code. It just talks to this interface.
    """
    ...
    async def query(
        ...
        Returns:
            A list of ScoredChunk objects containing the chunk text and similarity score.
        """
        pass
